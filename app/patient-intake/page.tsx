...
export default function PatientIntakePage() {
  return (
    <main style={{ paddingTop: '10rem', paddingBottom: '6rem', background: '#f8fafc', minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
      <div style={{ maxWidth: '600px', margin: '0 auto', padding: '3rem', background: 'white', borderRadius: '24px', boxShadow: '0 10px 25px rgba(0,0,0,0.05)', textAlign: 'center', border: '1px solid #e2e8f0' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem', alignItems: 'center' }}>
          <a href="/Homeopathic_Case_Record.pdf" download="Homeopathic_Case_Record.pdf" className="btn-primary" style={{ width: '100%', maxWidth: '300px', display: 'flex', justifyContent: 'center', gap: '0.5rem' }}>
          ...
          <p style={{ fontSize: '0.9rem', color: '#64748b', marginTop: '1rem' }}>
            ...
            <a href="mailto:awantidhadphale@gmail.com" style={{ color: 'var(--primary)', fontWeight: '600', textDecoration: 'none' }}>awantidhadphale@gmail.com</a>
          </p>
        </div>
